...
function EmailAutoComplete(options) {
    ...
    this.config = {
        targetCls: '',       // 目标input元素
        parentCls: '',       // 当前input元素的父级类
        hiddenCls: '',       // 当前input隐藏域 
        searchForm: '', //form表单
        hoverBg: 'hoverBg',          // 鼠标移上去的背景
        inputValColor: 'red',              // 输入框输入提示颜色
        mailArr: ["@qq.com.htm"/*tpa=http://www.hougelou.com/js/Tool/@qq.com*/, "@126.com.htm"/*tpa=http://www.hougelou.com/js/Tool/@126.com*/, "@163.com.htm"/*tpa=http://www.hougelou.com/js/Tool/@163.com*/, "@yahoo.com.htm"/*tpa=http://www.hougelou.com/js/Tool/@yahoo.com*/, "@sohu.com.htm"/*tpa=http://www.hougelou.com/js/Tool/@sohu.com*/, "@sina.com.htm"/*tpa=http://www.hougelou.com/js/Tool/@sina.com*/], //邮箱数组
    ...
    _renderHTML: function (cfg) {
        ...
        if (curIndex > -1) {
            ...
            if (_cache.onlyFlag) {
                ...
                $('.auto-tip', cfg.parentNode).css({ 'position': 'absolute', 'top': cfg.height, 'width': cfg.width - 2 + 'px', 'left': 90,
                    'border': '1px solid #ccc', 'z-index': 10000,'background': '#fff'
                });
            }
